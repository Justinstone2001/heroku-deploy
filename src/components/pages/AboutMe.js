...
export default function AboutMe() {
    return (
        ...
        <div className='aboutDiv' id='about'>
            <img alt='avatar' src='https://avataaars.io/?avatarStyle=Circle&topType=ShortHairDreads01&accessoriesType=Blank&hairColor=BrownDark&facialHairType=MoustacheFancy&facialHairColor=BrownDark&clotheType=Hoodie&clotheColor=PastelOrange&eyeType=Default&eyebrowType=UpDown&mouthType=Disbelief&skinColor=Light'/>
